export default function EventsPage() {
  return (
    <div style={{ minHeight: '100vh', background: '#FFFFFF', paddingTop: '6rem', paddingBottom: '4rem' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 2rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
          ...
          <div style={{ borderRadius: 24, overflow: 'hidden', position: 'relative', minHeight: 360 }}>
            <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=700&q=80" alt="Influencer Collaborations" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
            <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', background: 'linear-gradient(to top, rgba(44,26,14,0.92), transparent)' }} />
            <div style={{ position: 'absolute', bottom: 0, left: 0, padding: '2rem' }}>
              <span style={{ background: '#C9A84C', color: '#2C1A0E', fontSize: '0.68rem', fontWeight: 700, textTransform: 'uppercase', padding: '0.3rem 0.9rem', borderRadius: 100, display: 'inline-block', marginBottom: '0.75rem' }}>Influencer Collaborations</span>
          ...
          <div style={{ borderRadius: 24, overflow: 'hidden', position: 'relative', minHeight: 360 }}>
            <img src="https://images.unsplash.com/photo-1424847651672-bf20a4b0982b?w=700&q=80" alt="Date Night Package" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
            <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', background: 'linear-gradient(to top, rgba(44,26,14,0.92), transparent)' }} />
            <div style={{ position: 'absolute', bottom: 0, left: 0, padding: '2rem' }}>
        ...
        <div style={{ marginTop: '3rem', background: '#2C1A0E', borderRadius: 24, padding: '3rem', textAlign: 'center' }}>
          ...
          <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" style={{ background: '#C9A84C', color: '#2C1A0E', padding: '0.9rem 2.5rem', borderRadius: 100, fontWeight: 700, fontSize: '0.9rem', textDecoration: 'none', display: 'inline-block' }}>
            WhatsApp Us
          </a>
        </div>
